...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Call add() method passing in two integer arguments ===");
        System.out.println("add(2, 3)     -> "+mo.add(2, 3));

        System.out.println("\n=== Call add() method passing in three integer arguments ===");
        System.out.println("add(1, 2, 3)  -> "+mo.add(1, 2, 3));

        System.out.println("\n=== Call add() method passing in two double arguments ===");
        System.out.println("add(1.5, 2.5) -> "+mo.add(1.5, 2.5));

        System.out.println("\n=== Call format() method passing in one string arguments ===");
        System.out.println("format(\"hello\")     -> "+mo.format("hello"));

        System.out.println("\n=== Call format() method passing in one integer arguments ===");
        System.out.println("format(42)            -> "+mo.format(42));

        System.out.println("\n=== Call format() method passing in two (one string and one integer) arguments ===");
