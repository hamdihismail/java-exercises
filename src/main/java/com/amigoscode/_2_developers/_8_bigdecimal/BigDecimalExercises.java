...
public class BigDecimalExercises {
    ...
    public static void demonstrateDoubleProblem() {
        ...
        System.out.println("The String constructor is preferred because it preserves the values exactly.\n" +
                "The constructor translates the double into binary floating-point value, which can't be represented \n" +
                "perfectly for values like (0.1), resulting in unpredictable values");
